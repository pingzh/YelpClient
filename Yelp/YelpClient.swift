...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, radius_filter: Double?, completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
